...
def parse_option():
    ...
    parser.add_argument('--n_unlabelled', type=int, default=100, metavar='N', help='Number of unlabelled in test')
    ...
    parser.add_argument('--denoising_iterations', type=int, default=200, metavar='N', help='denoising steps')
    ...
    parser.add_argument('--init_ft_iter', type=int, default=10, metavar='N', help='initial fine-tuning iterations')
